...
anthropic_auth_token="$(get_env_value ANTHROPIC_AUTH_TOKEN)"
anthropic_api_key="$(get_env_value ANTHROPIC_API_KEY)"
anthropic_model="$(get_env_value ANTHROPIC_MODEL)"
...
anthropic_model="${anthropic_model:-example-ollama-model}"
...
[[ -n "${anthropic_base_url}" ]] || fail "ANTHROPIC_BASE_URL must not be empty"
[[ -n "${anthropic_auth_token}" ]] || fail "ANTHROPIC_AUTH_TOKEN must not be empty"
[[ -n "${anthropic_model}" ]] || fail "ANTHROPIC_MODEL must not be empty"
...
set_env_value ANTHROPIC_BASE_URL "${anthropic_base_url}"
set_env_value ANTHROPIC_AUTH_TOKEN "${anthropic_auth_token}"
set_env_value ANTHROPIC_API_KEY "${anthropic_api_key}"
set_env_value ANTHROPIC_MODEL "${anthropic_model}"
...
echo "Claude endpoint: ${anthropic_base_url}"
