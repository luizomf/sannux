...
pi_coding_agent_dir="$(get_env_value PI_CODING_AGENT_DIR)"
...
[[ -n "${pi_coding_agent_dir}" ]] || fail "PI_CODING_AGENT_DIR must not be empty"
[[ "${pi_coding_agent_dir}" == /home/agent/* ]] || fail "PI_CODING_AGENT_DIR must stay under /home/agent: ${pi_coding_agent_dir}"
...
install -d -m 0700 "${agent_home_path}/.pi/agent"
install -d -m 0700 "${agent_home_path}/.pi/agent/sessions"

echo "Workspace: ${workspace_path}"
echo "Agent home: ${agent_home_path}"
echo "Pi agent dir: ${agent_home_path}/.pi/agent"
