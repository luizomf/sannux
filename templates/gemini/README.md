...
- `Dockerfile`: Gemini CLI plus common Linux development tools, including RTK.
...
- Current Node.js LTS + Gemini CLI (`@google/gemini-cli`).
...
checksum. Use `just rebuild gemini` at the repo root or
