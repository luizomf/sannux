...
install -d -m 0700 "${agent_home_path}/.config/opencode"
install -d -m 0700 "${agent_home_path}/.local/share/opencode"

echo "Workspace: ${workspace_path}"
echo "Agent home: ${agent_home_path}"
echo "OpenCode config dir: ${agent_home_path}/.config/opencode"
echo "OpenCode data dir: ${agent_home_path}/.local/share/opencode"
